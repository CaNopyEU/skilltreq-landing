export default {
  ...
  'demo.desc.ring-support':
    'Static hold on rings with arms locked out. Foundation for all ring work.',
  'demo.desc.ring-dip':
  ...
  'demo.desc.tmb-cartwheel':
    'Lateral rotation through hand-hand-foot-foot pattern with straight legs.',
  'demo.desc.tmb-one-hand-cw':
    'Cartwheel with only one hand touching the ground. Builds aerial awareness.',
  'demo.desc.tmb-aerial':
    'No-hands cartwheel — a true aerial rotation. The iconic tumbling milestone.',
  'demo.desc.tmb-round-off':
    'Cartwheel variant that lands with both feet together facing the start. Entry for flips.',
  'demo.desc.tmb-bridge':
